...
(function () {
  var e,
    ...
    function r(t) {
      ...
      var r, i, s, o, u, a, f, l, c, h, p, d;n == null && (n = !0);if (e == null || e.length === 0) {
      ...
      var n, r;return t == null && (t = 12), r = this.raphael.text(100, 100, e).attr("font-size", t), n = r.getBBox(), r.remove(), n;
      ...
      var e, t, n, r, i, s, o, u;if (this.options.grid === !1 && this.options.axes === !1) return;e = this.ymin, t = this.ymax, u = [];for (n = s = e, o = this.yInterval; e <= t ? s <= t : s >= t; n = s += o) {
    ...
    function n(n) {
      ...
      var n, r, i, s, o, u;return o = this.options.parent.innerWidth(), s = this.options.parent.innerHeight(), r = this.el.outerWidth(), n = this.el.outerHeight(), i = Math.min(Math.max(0, e - r / 2), o - r), t != null ? (u = t - n - 10, u < 0 && (u = t + 10, u + n > s && (u = s / 2 - n / 2))) : u = s / 2 - n / 2, this.el.css({ left: i + "px", top: u + "px" });
    ...
    function n(e) {
      this.hilight = u(this.hilight, this), this.onHoverOut = u(this.onHoverOut, this), this.onHoverMove = u(this.onHoverMove, this);if (!(this instanceof t.Line)) return new t.Line(e);n.__super__.constructor.call(this, e);
    }return o(n, e), n.prototype.init = function () {
      this.pointGrow = Raphael.animation({ r: this.options.pointSize + 3 }, 25, "linear"), this.pointShrink = Raphael.animation({ r: this.options.pointSize }, 25, "linear");if (this.options.hideHover !== "always") return this.hover = new t.Hover({ parent: this.el }), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut);
      ...
      var t, n, r, i, s, o, u;r = this.data[e];if (typeof this.options.hoverCallback == "function") t = this.options.hoverCallback(e, this.options);else {
        t = "<div class='morris-hover-row-label'>" + r.label + "</div>", u = r.y;for (n = s = 0, o = u.length; s < o; n = ++s) {
      ...
      var e,
          ...
          a,
          f,
          l = this;o = this.bottom + this.options.gridTextSize * 1.25, i = null, e = function e(_e, t) {
        var n, r;return n = l.drawXAxisLabel(l.transX(t), o, _e), r = n.getBBox(), (i == null || i >= r.x + r.width) && r.x >= 0 && r.x + r.width < l.el.width() ? i = r.x - l.options.xLabelMargin : n.remove();
      ...
      }.call(this), r.reverse(), f = [];for (u = 0, a = r.length; u < a; u++) {
        n = r[u], f.push(e(n[0], n[1]));
      }return f;
    }, n.prototype.drawSeries = function () {
      var e, t, n, r, i, s, o, u, a;for (t = i = o = this.options.ykeys.length - 1; o <= 0 ? i <= 0 : i >= 0; t = o <= 0 ? ++i : --i) {
        n = this.paths[t], n !== null && this.drawLinePath(n, this.colorFor(r, t, "line"));
      }this.seriesPoints = function () {
        var e, n, r;r = [];for (t = e = 0, n = this.options.ykeys.length; 0 <= n ? e < n : e > n; t = 0 <= n ? ++e : --e) {
          r.push([]);
        }return r;
      }.call(this), a = [];for (t = s = u = this.options.ykeys.length - 1; u <= 0 ? s <= 0 : s >= 0; t = u <= 0 ? ++s : --s) {
        a.push(function () {
          var n, i, s, o;s = this.data, o = [];for (n = 0, i = s.length; n < i; n++) {
    ...
    function n(e) {
      if (!(this instanceof t.Area)) return new t.Area(e);this.cumulative = !0, n.__super__.constructor.call(this, e);
      ...
      var e, t, r, i;for (e = r = i = this.options.ykeys.length - 1; i <= 0 ? r <= 0 : r >= 0; e = i <= 0 ? ++r : --r) {
      ...
      var t;return t = Raphael.rgb2hsl(this.colorFor(this.data[e], e, "line")), Raphael.hsl(t.h, Math.min(255, t.s * .75), Math.min(255, t.l * 1.25));
    }, n.prototype.drawFilledPath = function (e, t) {
      return this.raphael.path(e).attr("fill", t).attr("stroke-width", 0);
    }, n;
  }(t.Line), t.Bar = function (n) {
    function r(n) {
      this.onHoverOut = u(this.onHoverOut, this), this.onHoverMove = u(this.onHoverMove, this);if (!(this instanceof t.Bar)) return new t.Bar(n);r.__super__.constructor.call(this, e.extend({}, n, { parseTime: !1 }));
    }return o(r, n), r.prototype.init = function () {
      this.cumulative = this.options.stacked;if (this.options.hideHover !== "always") return this.hover = new t.Hover({ parent: this.el }), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut);
      ...
      var e, t, n, r, i, s, o, u, a;s = this.bottom + this.options.gridTextSize * 1.25, r = null, a = [];for (e = o = 0, u = this.data.length; 0 <= u ? o < u : o > u; e = 0 <= u ? ++o : --o) {
      ...
      var t, n, r, i, s, o, u, a;if (typeof this.options.hoverCallback == "function") t = this.options.hoverCallback(e, this.options);else {
        r = this.data[e], t = "<div class='morris-hover-row-label'>" + r.label + "</div>", a = r.y;for (n = o = 0, u = a.length; o < u; n = ++o) {
      ...
      var r;return r = this.raphael.text(e, t, n).attr("font-size", this.options.gridTextSize).attr("fill", this.options.gridTextColor);
    ...
    function n(n) {
      this.select = u(this.select, this);if (!(this instanceof t.Donut)) return new t.Donut(n);typeof n.element == "string" ? this.el = e(document.getElementById(n.element)) : this.el = e(n.element), this.options = e.extend({}, this.defaults, n);if (this.el === null || this.el.length === 0) throw new Error("Graph placeholder not found.");if (n.data === void 0 || n.data.length === 0) return;this.data = n.data, this.redraw();
      ...
      var e, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x;this.el.empty(), this.raphael = new Raphael(this.el[0]), n = this.el.width() / 2, r = this.el.height() / 2, h = (Math.min(n, r) - 10) / 3, c = 0, w = this.data;for (d = 0, g = w.length; d < g; d++) {
        p = w[d], c += p.value;
      }a = 5 / (2 * h), e = 1.9999 * Math.PI - a * this.data.length, o = 0, s = 0, this.segments = [], E = this.data;for (v = 0, y = E.length; v < y; v++) {
      ...
      }.call(this)), s = 0, S = this.data, x = [];for (m = 0, b = S.length; m < b; m++) {
        i = S[m];if (i.value === u) {
          this.select(s);break;
        }x.push(s += 1);
      }return x;
    }, n.prototype.select = function (e) {
      var t, n, r, i, s;s = this.segments;for (r = 0, i = s.length; r < i; r++) {
        t = s[r], t.deselect();
